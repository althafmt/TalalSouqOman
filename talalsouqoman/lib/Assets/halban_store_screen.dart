...
class HalbanStoreScreen extends StatefulWidget {
  const HalbanStoreScreen({super.key});

  @override
  State<HalbanStoreScreen> createState() => _HalbanStoreScreenState();
}

class _HalbanStoreScreenState extends State<HalbanStoreScreen> {
  ...
  Future<void> _fetchAssets() async {
    ...
    try {
      final response = await _supabase.from('HalbanStoreassets').select();
      setState(() {
  ...
  Future<void> _addAsset() async {
    ...
    setState(() => _isLoading = true);
    try {
      await _supabase.from('HalbanStoreassets').insert({
        'place': _place,
        'type': _type,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Halban Store Assets"),
