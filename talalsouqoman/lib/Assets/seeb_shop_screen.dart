...
class SeebShopScreen extends StatefulWidget {
  const SeebShopScreen({super.key});

  @override
  State<SeebShopScreen> createState() => _SeebShopScreenState();
}

class _SeebShopScreenState extends State<SeebShopScreen> {
  ...
  Future<void> _fetchAssets() async {
    ...
    try {
      final response = await _supabase.from('SeebShopassets').select();
      setState(() {
  ...
  Future<void> _addAsset() async {
    ...
    setState(() => _isLoading = true);
    try {
      await _supabase.from('SeebShopassets').insert({
        'place': _place,
        'type': _type,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Seeb Shop Assets"),
