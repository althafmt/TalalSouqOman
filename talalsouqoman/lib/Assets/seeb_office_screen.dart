...
class SeebOfficeScreen extends StatefulWidget {
  const SeebOfficeScreen({super.key});

  @override
  State<SeebOfficeScreen> createState() => _SeebOfficeScreenState();
}

class _SeebOfficeScreenState extends State<SeebOfficeScreen> {
  ...
  Future<void> _fetchAssets() async {
    ...
    try {
      final response = await _supabase.from('SeebOfficeassets').select();
      setState(() {
  ...
  Future<void> _addAsset() async {
    ...
    setState(() => _isLoading = true);
    try {
      await _supabase.from('SeebOfficeassets').insert({
        'place': _place,
        'type': _type,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Seeb Office Assets"),
